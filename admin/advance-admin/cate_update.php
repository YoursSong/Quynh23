            ...
            <div class="col-md-12 col-sm-12 col-xs-24">
               <div class="panel panel-info">
                        ...
                        <?php
                            ...
                            if(isset($_GET['up'])) {
                                $se = $get_data->se_up_cate($_GET['up']);
                                foreach($se as $up_pro) {
                            ?>
                            <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Name category</label>
                                            <input class="form-control" type="text" name="txtname" value="<?php echo $up_pro['Category'];?>">
                                            <p class="help-block">Help text here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <input class="form-control" type="text" name="txtdes"value="<?php echo $up_pro['Description'];?>">
                                            <p class="help-block">Help text here.</p>
                                        </div>
                                    ...
                                    if(isset($_POST['txtsub'])) {
                                        $up_pro = $get_data->update_cate($_POST['txtname'], $_POST['txtdes'], $_GET['up']);
                                        if($up_pro) {
