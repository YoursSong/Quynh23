    ...
    height: 100vh;">
        ...
        <div id="page-wrapper">
            <div>
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Danh sách phòng khách sạn</h1>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td><a href="room_update.php?up=<?php echo $se_pros['id_room']?>">Update</a></td>
                                    <td><a href="room_delete.php?del=<?php echo $se_pros['id_room']?>"
                                ...
                                <button class="btn btn-info"><a href="./insert_room.php" style="text-decoration: none; color: white;">Thêm phòng khách sạn</a></button>
                            </div>
                        </div>
                    </div>
                     <!-- End  Kitchen Sink -->
