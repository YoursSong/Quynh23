    ...
    height: 100vh;">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#" class="active-menu"><i class="fa fa-envelope "></i>Phản hồi</a>
                    </li>
                      <li>
        ...
        <div id="page-wrapper">
            <div>
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Phản hồi từ người dùng</h1>
                    ...
                    <div class="panel panel-default wi" style="width:90%;margin-left:15px;">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $se_con['id_contact']?></td>
                                    <td><?php echo $se_con['name']?></td>
                                    <td><?php echo $se_con['email']?></td> 
                                    <td><?php echo $se_con['tel']?></td>
                                    <td><?php echo $se_con['address']?></td>
                                    <td><?php echo $se_con['title']?></td>
                                    <td><?php echo $se_con['comment']?></td>
                                    <td><a href="contact_delete.php?del=<?php echo $se_con['id_contact']?>"
